          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            {orders.length === 0 ? (
              <div className="text-center py-20 text-gray-400 bg-[#fafbfc] rounded-3xl border border-dashed border-gray-250">
                ...
                <Link to="/" className="inline-flex items-center gap-2 bg-[#164475] hover:bg-[#0a1b2d] text-white font-bold px-6 py-3 rounded-full text-xs transition-all shadow-md">
                  Browse Shop
                </Link>
              </div>
            ) : (
