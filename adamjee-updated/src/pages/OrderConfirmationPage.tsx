          ...
          <div className="space-y-6 animate-fade-in-up delay-100">
            <div className="bg-[#03152a] rounded-3xl p-6 md:p-8 text-white border border-white/5 shadow-2xl">
              ...
              <div className="space-y-3">
                <Link to="/" className="w-full flex items-center justify-center gap-2 bg-[#164475] hover:bg-[#164475]/90 text-[#03152a] py-3.5 rounded-xl font-black text-xs tracking-wider transition-all shadow-md">
                  <Home className="w-4 h-4" /> Continue Shopping
                </Link>
                <Link to="/account" className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white py-3.5 rounded-xl font-bold text-xs tracking-wider transition-colors border border-white/10">
