                  ...
                  {cart.map(item => (
                    <div key={item.product.id} className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center relative pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                      <div className="col-span-1 sm:col-span-6 flex items-center gap-4">
                        <Link to={`/product/${item.product.id}`} className="w-24 h-24 bg-gray-50 rounded-xl border border-gray-100 p-2 flex-shrink-0 flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <Link to={`/product/${item.product.id}`} className="text-[#0a1b2d] font-bold hover:text-[#164475] transition-colors leading-tight">
                            {item.product.name}
                          </Link>
                        </div>
                      </div>
