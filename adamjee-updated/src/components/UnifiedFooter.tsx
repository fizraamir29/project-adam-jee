          ...
          <div className="md:col-span-7 lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <nav className="flex flex-col gap-3">
                <Link to="/category/all" className={navLinkClass}>All Products</Link>
                <button onClick={() => setIsBuilderOpen(true)} className={navLinkClass}>
                  Custom PC Builds
                </button>
                <Link to="/category/accessories" className={navLinkClass}>Gaming Accessories</Link>
                <Link to="/category/sale" className={navLinkClass}>Flash Sale</Link>
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col gap-3">
                <Link to="/about" className={navLinkClass}>Our Story</Link>
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col gap-3">
                <Link to="/warranty-returns" className={navLinkClass}>Shipping &amp; Returns</Link>
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-8 pb-4">
            ...
            <div className="flex items-center gap-6 text-sm text-white/75">
              <Link to="/accessibility" className={navLinkClass}>Accessibility</Link>
              <Link to="/terms" className={navLinkClass}>Terms of Service</Link>
