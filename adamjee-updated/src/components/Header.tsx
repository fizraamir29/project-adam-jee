  ...
  return (
    ...
    >
      ...
      <nav className="hidden lg:flex items-center gap-8 text-[13px] font-medium tracking-wide text-gray-600">
        <Link to="/category/all" className="text-[#164475] font-bold inline-flex items-center gap-1.5 nav-link-underline">
          <span className="w-1.5 h-1.5 rounded-full bg-[#164475] inline-block shrink-0" style={{ marginTop: '1px' }}></span>
          <span>Shop</span>
        </Link>
        <Link to="/category/best-sellers" className="nav-link-underline hover:text-[#164475] transition-colors">
          Best Sellers
        </Link>
        <Link
          to="/build-your-pc"
        ...
        <Link to="/benchmarks" className="nav-link-underline hover:text-[#164475] transition-colors">
          Benchmarks
        </Link>
        <Link to="/about" className="nav-link-underline hover:text-[#164475] transition-colors">
          Why Us
        </Link>
      </nav>

      <div className="flex items-center gap-5 text-gray-800">
        <Link to="/search" className="icon-hover-scale hover:text-[#164475] transition-colors cursor-pointer bg-transparent border-none p-0 flex items-center justify-center">
        ...
        <Link to="/login" className="icon-hover-scale hover:text-[#164475] transition-colors cursor-pointer bg-transparent border-none p-0 flex items-center justify-center">
